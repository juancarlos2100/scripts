...
$UnattendPath = 'C:\Users\Administrador\Desktop\Scrips\Autounattend.xml'

# Mount the VHDX
Mount-VHD -Path $path_to_disk\$vm-disk1.vhdx

# Copy the Autounattend.xml file to the mounted VHDX
Copy-Item -Path $UnattendPath -Destination 'C:\Hyper-V'

# Dismount the VHDX
Dismount-VHD -Path $path_to_disk\$vm-disk1.vhdx
